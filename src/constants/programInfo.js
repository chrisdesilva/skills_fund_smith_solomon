...
export const leadContent = {
	...
	paragraph: `${schoolName} designs its programs to provide students with a foundation for a career as a commercial driver. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving
		? ' and cost of living'
