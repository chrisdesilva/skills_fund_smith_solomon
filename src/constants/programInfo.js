...
export const leadContent = {
    ...
    paragraph: `${schoolName} designs its programs to provide students with a foundation for a career as a commercial driver. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving ? ' and cost of living' : ''} financing so more students like you can access their program.`
}
...
export const programLoanInfo = [ // update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
    {
        ...
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SASSFTI19",
    ...
    },
    {
        ...
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SASSPT19",
        loanInfo: { // match loanInfo in first metro below
            maxLoanAmt: 5000,
            loanTerm36: true,
            loanTerm60: false,
...
export const programMaxText = "Choose the loan amount that works best for you. Borrow up to $4,500 for tuition and up to $500 for cost of living for either program."
